...
for(driverFile in driversFiles){
  ...
  model  <- svm(x= train[,-c(1,2,ncol(train))], y=train[,ncol(train)],kernel ="radial", type="C-classification",cost =1, scale = T)
  ...
  outputFile = "/Users/gidutz/Downloads/kaggle/drivers/result/file16.txt"
